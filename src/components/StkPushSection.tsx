...
import { FiSmartphone, FiRefreshCw, FiCheck, FiX, FiZap } from 'react-icons/fi';
 ...
 * StkPushSection
 *
 * UI component for the M-Pesa STK Push flow.
 * Renders phone input, send button, and real-time status display.
 *
 * Status states:
 ...
 * Requirements: 6.1, 6.4, 6.5, 6.6, 6.7, 6.9, 6.10, 6.11
 */
        ...
        >
            ...
            <div className="px-4 py-3 border-b border-green-200 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-[10px] text-green-700 mt-0.5">Send a payment prompt directly to the tenant's phone</p>
                </div>
            </div>
            ...
            <div className="px-4 py-4 space-y-3">
                ...
                <div>
                    ...
                    <p className="text-[10px] text-green-600 mt-1">Auto-filled from tenant record. Edit if needed.</p>
                </div>
                ...
                {status === 'idle' && (
                    <button
                        ...
                        style={{
                            background: isDisabled ? '#f1f5f9' : 'linear-gradient(135deg, #22c55e, #16a34a)',
                ...
                {status === 'pending' && (
                    <div className="flex items-center gap-3 px-4 py-3 bg-white rounded-xl border border-amber-200" style={{ background: '#fffbeb' }}>
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-amber-600 mt-0.5">Checking every 3 seconds · Tenant should see a prompt on their phone</p>
                        </div>
                    </div>
                )}
                ...
                {status === 'success' && (
                    <div className="flex items-center gap-3 px-4 py-3 rounded-xl border border-green-300" style={{ background: '#f0fdf4' }}>
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-green-600 mt-0.5">M-Pesa receipt has been auto-filled below</p>
                        </div>
                    </div>
                )}
                ...
                {status === 'failed' && (
                    <div className="space-y-2">
                        <div className="flex items-start gap-3 px-4 py-3 rounded-xl border border-red-200" style={{ background: '#fef2f2' }}>
