                    ...
                    <div key={size}>
                        ...
                        <div className={`card ${isPhoto ? 'photo-card' : 'a5-card'}`}>
                            ...
                            <div className="header">
                                ...
                                <div className="pay-mode">💳 Payment Mode: <strong>ARMS TENANT MOBILE APK VER.2.1</strong></div>
                                <div className="notice-banner">
                                    <div className="notice-title">⚠️ IMPORTANT NOTICE</div>
                                    We have changed the payment mode from <strong style={{color:'#fca5a5'}}>Bank Account</strong> to <strong style={{color:'#6ee7b7'}}>ARMS Tenant Mobile APK Ver.2.1</strong>. Please scan the QR code above to download the app and pay rent directly from your phone.
                                </div>
                            </div>
                            ...
                            <div className="steps">
                                {[
                                    ...
                                    ['2','Download & install ARMS Mobile APK v2.1'],
